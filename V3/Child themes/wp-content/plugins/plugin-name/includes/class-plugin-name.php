...
class Plugin_Name {
	...
	private function define_admin_hooks() {
		...
		//creates a custom post type to hlod our videos 
	...
	private function define_public_hooks() {
		...
		$this->loader->add_shortcode( 'wp10shortcode1',$plugin_public, 'public_hello_world' );
		

		//add shortcode  for our Plugin
		$this->loader->add_shortcode( 'wp10yvidsout',$plugin_public, 'wp10viddisplay' ); //gird display
		$this->loader->add_shortcode( 'wp10ydisplaybox',$plugin_public, 'wp10ydisplaybox' ); //display the request video
