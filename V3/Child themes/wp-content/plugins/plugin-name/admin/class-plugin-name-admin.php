...
class Plugin_Name_Admin {
	...
	*/
	...
	{
		add_menu_page( 'New Plugin Setting', 'WP10OrLess Settings', 'manage_options', 'plugin-name/mainsettings.php', array($this, 'myplugin_admin_page'), 'dashicons-tickets', 250 );
		add_submenu_page( 'plugin-name/mainsettings.php', 'Sub 1', 'WP10 Importer', 'manage_options', 'plugin-name/wp10importer.php', array( $this , 'wp10importercall' ));
		add_submenu_page( 'plugin-name/mainsettings.php', 'Sub 1', 'WP10 Settings', 'manage_options', 'partials/wp10settingscallback.php', array( $this , 'wp10settingscallback' ));
	}
	...
	{
		//registers the shortcode settings
