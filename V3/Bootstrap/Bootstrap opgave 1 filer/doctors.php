...
<div class="container row  mx-auto">
  ...
  <section class="mb-5 col-xl-4 col-md-6 col-sm-12 card-group" id="drwinthrop">
    <div class="card">
  ...
  <section class="mb-5 col-xl-4 col-md-6 col-sm-12 card-group" id="drchase">
    <div class="card">
      <div class="card-header">
    ...
    <section class="mb-5 col-xl-4 col-md-6 col-sm-12 card-group" id="drsanders">
    <div class="card">
      <div class="card-header">
  ...
  <section class="mb-5 col-xl-4 col-md-6 col-sm-12 card-group" id="drgardner">
    <div class="card">
      <div class="card-header">
  ...
  <section class="mb-5 col-xl-4 col-md-6 col-sm-12 card-group" id="drruiz">
    <div class="card">
      <div class="card-header">
  ...
  <section class="mb-5 col-xl-4 col-md-6 col-sm-12 card-group" id="drwong">
    <div class="card">
      <div class="card-header">
