        ...
        <section>
            ...
            <form action="order.php" method="post" class="bouquet">
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Calla Lily" target="_blank">Calla Lilies</a></h4>
                        <p>$3.00 per stem</p>
                        <div class="color">
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Sunflower" target="_blank">Sunflowers</a></h4>
                        <p>$3.00 per stem</p>
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Iris" target="_blank">Iris</a></h4>
                        <p>$2.00 per stem</p>
                        <div class="color invisible">
                            <label>Dummy</label>
                            <select>
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Peruvian Lily" target="_blank">Peruvian Lilies</a></h4>
                        <p>$2.00 per stem</p>
                        <div class="color invisible">
                            <label>Dummy</label>
                            <select>
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Daffodil" target="_blank">Daffodils</a></h4>
                        <p>$2.00 per stem</p>
                        <div class="color invisible">
                            <label>Dummy</label>
                            <select>
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Gerbera" target="_blank">Gerbera</a></h4>
                        <p>$3.00 per stem</p>
                        <div class="color">
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Dendrobium" target="_blank">Dendrobium</a></h4>
                        <p>$4.00 per stem</p>
                        <div class="color invisible">
                            <label>Dummy</label>
                            <select>
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Rose" target="_blank">Roses</a></h4>
                        <p>$3.00 per stem</p>
                        <div class="color">
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Lily" target="_blank">Lilies</a></h4>
                        <p>$3.00 per stem</p>
                        <div class="color">
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Tulip" target="_blank">Tulips</a></h4>
                        <p>$2.00 per stem</p>
                        <div class="color">
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Lilac" target="_blank">Lilacs</a></h4>
                        <p>$4.00 per stem</p>
                        <div class="color invisible">
                            <label>Dummy</label>
                            <select>
                ...
                <fieldset>
                    ...
                    <div>
                        <h4><a href="flwrdetails.php?name=Daisy" target="_blank">Daisies</a></h4>
                        <p>$1.00 per stem</p>
                        <div class="color invisible">
                            <label>Dummy</label>
                            <select>
